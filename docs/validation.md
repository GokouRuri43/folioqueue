...
- `python -m pytest --cov=folioqueue --cov-report=term-missing`: **45 passed, 2 skipped**, 94% measured statement coverage, including worker subprocesses. The skips are local symlink creation privileges and a case-sensitive-filesystem test.
